...
abstract class _$RecipeDatabase extends GeneratedDatabase {
  ...
  _$RecipeDatabaseManager get managers => _$RecipeDatabaseManager(this);
...
typedef $$DbRecipeTableInsertCompanionBuilder = DbRecipeCompanion Function({
  Value<int> id,
  required String label,
  required String image,
  required String description,
...
class $$DbRecipeTableTableManager extends RootTableManager<
    ...
    $$DbRecipeTableProcessedTableManager,
    $$DbRecipeTableInsertCompanionBuilder,
  ...
  $$DbRecipeTableTableManager(_$RecipeDatabase db, $DbRecipeTable table)
      : super(TableManagerState(
          ...
          getChildManagerBuilder: (p) =>
              $$DbRecipeTableProcessedTableManager(p),
...
class $$DbRecipeTableProcessedTableManager extends ProcessedTableManager<
    _$RecipeDatabase,
    $DbRecipeTable,
    DbRecipeData,
    $$DbRecipeTableFilterComposer,
    ...
    $$DbRecipeTableInsertCompanionBuilder,
    $$DbRecipeTableUpdateCompanionBuilder> {
  $$DbRecipeTableProcessedTableManager(super.$state);
}
...
typedef $$DbIngredientTableInsertCompanionBuilder = DbIngredientCompanion
    Function({
  Value<int> id,
  required int recipeId,
  required String name,
...
class $$DbIngredientTableTableManager extends RootTableManager<
    ...
    $$DbIngredientTableProcessedTableManager,
    $$DbIngredientTableInsertCompanionBuilder,
  ...
  $$DbIngredientTableTableManager(_$RecipeDatabase db, $DbIngredientTable table)
      : super(TableManagerState(
          ...
          getChildManagerBuilder: (p) =>
              $$DbIngredientTableProcessedTableManager(p),
          getUpdateCompanionBuilder: ({
            Value<int> id = const Value.absent(),
...
class $$DbIngredientTableProcessedTableManager extends ProcessedTableManager<
    _$RecipeDatabase,
    $DbIngredientTable,
    DbIngredientData,
    $$DbIngredientTableFilterComposer,
    ...
    $$DbIngredientTableInsertCompanionBuilder,
    $$DbIngredientTableUpdateCompanionBuilder> {
  $$DbIngredientTableProcessedTableManager(super.$state);
}
...
class _$RecipeDatabaseManager {
  final _$RecipeDatabase _db;
  _$RecipeDatabaseManager(this._db);
