defmodule Contexts.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Contexts.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Contexts.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Contexts.ShoppingCart.create_cart_item()
