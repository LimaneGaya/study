class Post {
  String id, profileImageUrl, comment, timestamp;
  Post(this.id, this.profileImageUrl, this.comment, this.timestamp);
}

List<Post> posts = [
  Post('1', 'assets/profile_pics/person_cesare.webp',
      'Made this delicious pizza this morning', '10'),
  Post('2', 'assets/profile_pics/person_stef.webp',
      'Made delicious creamy, shrimp black pepper pasta.', '80'),
  Post('3', 'assets/profile_pics/person_crispy.webp',
      'Made a delicious salad today!', '20'),
  Post('4', 'assets/profile_pics/person_joe.webp',
  ...
  Post(
      ...
      '50'),
  Post('8', 'assets/profile_pics/person_manda.webp',
      'Not sure where I should travel to eat today.', '60'),
  Post('9', 'assets/profile_pics/person_ray.webp',
      'Hot off the press, cooking up more books this year!', '70'),
  Post('10', 'assets/profile_pics/person_tiffani.webp',
